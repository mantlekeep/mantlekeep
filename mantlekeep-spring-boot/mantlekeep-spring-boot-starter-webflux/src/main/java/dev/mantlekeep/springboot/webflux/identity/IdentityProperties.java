 ...
 *                    terminated authentication (default {@code X-Mantlekeep-User})
 * @param rolesHeader header carrying comma-separated roles (default {@code X-Mantlekeep-Roles})
...
public record IdentityProperties(String userHeader, String rolesHeader, String devUser) {
    ...
    public IdentityProperties {
        userHeader = blankTo(userHeader, "X-Mantlekeep-User");
        rolesHeader = blankTo(rolesHeader, "X-Mantlekeep-Roles");
